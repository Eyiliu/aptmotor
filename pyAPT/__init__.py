...
__all__ = ['Message', 'Controller', 'MTS50', 'Z8xx', 'add_PID', 'clear_PIDs', 'OutOfRangeError']

from pyAPT import message, controller, mts50, z8xx
...
# MoterEW = z8xx.MoterEW
# MoterSN = z8xx.MoterSN
# MoterDU = z8xx.MoterDU
